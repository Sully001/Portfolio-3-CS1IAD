    ...
    <div class="container-fluid">
      ...
      <ul class='navbar-nav me-auto'>
        ...
        echo "<li class='nav-item'>
            <a class='nav-link active' aria-current='page' href='currentcv.php'>Edit My CV</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link active' id='padding' aria-current='page' href='logout.php'>Logout</a>
          </li>";
      } else {
        echo "<li class='nav-item'>
